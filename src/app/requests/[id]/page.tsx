        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <div className="card p-6">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-green-500 hover:bg-green-600 text-white font-bold text-sm transition-all active:scale-95 shadow-sm shadow-green-200 w-full justify-center"
            >
